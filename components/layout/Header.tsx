      ...
      <header className="bg-white border-b border-b-gray-300 relative">
        ...
        {!isExpanded && (
          <div className="py-2 px-4 flex justify-between items-center">
            <div className="text-xl font-bold bg-gradient-to-r from-teal-500 via-emerald-500 to-blue-500 bg-clip-text text-transparent">
              ClimbNow
            </div>
          </div>
        )}
        <button
            ...
            className="absolute bottom-2 right-2 transform -translate-x-1/2 bg-white border border-gray-300 rounded-full w-8 h-8 flex items-center justify-center shadow-md hover:bg-gray-50 transition-colors duration-200 focus:outline-none"
